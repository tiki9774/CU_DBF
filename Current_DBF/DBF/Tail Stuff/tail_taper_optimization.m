%% known parameters
bh = 20.18; % horizontal tail span [in]
Sht = 113.13; % horizontal tail area [in]
bv = 13.45; % vertical tail height [in]
Svt = 106.38; % vertical tail area [in]
alpha0 = [0 0]; % zero-lift AoA for [root tip] [deg]
alpha = [2 2]; % AoA for [root tip] [deg]
